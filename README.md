...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-12-21 12:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/657ebffc-76ea-473a-95bc-ebd852dc2e65.git
$ cd 657ebffc-76ea-473a-95bc-ebd852dc2e65
```
